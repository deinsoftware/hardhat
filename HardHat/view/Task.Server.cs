...
namespace HardHat
{
    ...
    public static partial class Task
    {
        public static void ServerList(ref List<Option> opts)
        {
            ...
            opts.Add(new Option { opt = "t>f:a", status = false, action = Task.Quick, variant = "f:a" });
            opts.Add(new Option { opt = "t>f:b", status = false, action = Task.Quick, variant = "f:b" });
            opts.Add(new Option { opt = "t>f:m", status = false, action = Task.Quick, variant = "f:m" });
            opts.Add(new Option { opt = "t>f:s", status = false, action = Task.Quick, variant = "f:s" });
        ...
        public static void ServerStatus()
        {
            ...
            Options.IsValid("t>f:a", Variables.Valid("tp"));
            Options.IsValid("t>f:b", Variables.Valid("tp"));
            Options.IsValid("t>f:m", Variables.Valid("tp"));
            Options.IsValid("t>f:s", Variables.Valid("tp"));
